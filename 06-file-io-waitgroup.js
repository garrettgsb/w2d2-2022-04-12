// This is the code that I wrote on my own earlier, to demonstrate one (non-obvious) way to clean up the callback nesting
const fs = require('fs');
...
// Don't name your functions doTheThing, lol...
